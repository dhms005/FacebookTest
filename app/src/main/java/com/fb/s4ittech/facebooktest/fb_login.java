    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* profileTracker = new ProfileTracker() {
            ...
            protected void onCurrentProfileChanged(
                ...
                Toast.makeText(getBaseContext(), Profile.getCurrentProfile().getFirstName().toString(), Toast.LENGTH_SHORT).show();
                // App code
            }
        };*/
        ...
        //loginButton.setFragment(fb_login.this);
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                parameters.putString("fields", "id,name,first_name,location,last_name,email,gender, birthday,link");
